...
public class JavaMail {
	...
	public static String myEmailAccount = "ut_zabbix@163.com";
	public static String myEmailPassword = "ut123456";
	...
	// 收件人邮箱（替换为自己知道的有效邮箱）
	public static String receiveMailAccount = "wangpeng1@ut.cn";

	public static void sendMail(String receive, String subject, String content) throws Exception {
		...
		// 3. 创建一封邮件
		MimeMessage message = createMimeMessage(session, myEmailAccount, receive, subject, content);
	...
	public static MimeMessage createMimeMessage(Session session, String sendMail,
		...
		message.setFrom(new InternetAddress(sendMail, "优特物联", "UTF-8"));

		// 3. To: 收件人（可以增加多个收件人、抄送、密送）
		message.setRecipient(MimeMessage.RecipientType.TO,
				new InternetAddress(receiveMail, "管理员", "UTF-8"));
