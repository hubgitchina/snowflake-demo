...
public class ProcessInfoUtil {
	...
	public static String getPidNameByPid(String pid) throws Exception {
		...
		try {
			Process p = Runtime.getRuntime()
					.exec("TASKLIST /NH /FO CSV /FI \"PID EQ " + pid + "\"");
	...
	public static List<String> getPIDListByPidName(String pidName) throws Exception {
		...
		try {
			...
			Process p = Runtime.getRuntime()
					.exec("TASKLIST /NH /FO CSV /FI \"IMAGENAME EQ " + imageName + "\"");
			is = p.getInputStream();
			ir = new InputStreamReader(is);
			br = new BufferedReader(ir);
			while ((line = br.readLine()) != null) {
	...
	public static void main(String[] args) throws Exception {
		...
		List<String> list = getPIDListByPidName("javaw");
		for (String pid : list) {
			System.out.println(pid);
			Map<String, List<String>> temp = getPortByPID(pid);
		...
		// Map<String, List<String>> temp = getPortByPID(string);
		// for (Map.Entry<String, List<String>> entry : temp.entrySet()) {
